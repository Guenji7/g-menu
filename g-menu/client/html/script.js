...
function openSubRing() {
    document.getElementById('thick-ring').classList.add('hidden');
    document.getElementById('sub-ring').classList.remove('hidden');
}

function goBack() {
    document.getElementById('sub-ring').classList.add('hidden');
    document.getElementById('thick-ring').classList.remove('hidden');
}

function openDocumentRing() {
    document.getElementById('thick-ring').classList.add('hidden');
    document.getElementById('document-ring').classList.remove('hidden');
}

function closeDocumentRing() {
    document.getElementById('document-ring').classList.add('hidden');
    document.getElementById('thick-ring').classList.remove('hidden');
}

// Event-Handler für den Dokumenten-Button
document.querySelector('g[onclick="openDocumentRing()"]').addEventListener('click', () => {
    closeDocumentRing();
});